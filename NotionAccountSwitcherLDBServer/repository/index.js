...
const to_uuid_1 = require("to-uuid");
...
class Repository {
    ...
    getNotionDataPath() {
        ...
        if (this.getOsType() == 'darwin') {
            return `/Users/${userName}/Library/Application Support/Notion/Partitions/notion/Local Storage/leveldb`;
        }
        return null;
    }
    getLoggedInUser() {
        const db = levelup_1.default(encoding_down_1.default(leveldown_1.default(this.getNotionDataPath())));
            ...
            db.createReadStream({ keys: true, values: true })
                ...
                try {
                    ...
                    if (key == '_notion://www.notion.soajs_group_properties') {
                        ...
                        // console.log(value);
                        if (value.user_id && value.user_email) {
                            resolve({ notionUserId: to_uuid_1.toUUID(value.user_id), notionUserEmail: value.user_email });
                        }
                        else {
